      ...
      <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 pt-24 pb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-white/80 text-lg font-golos mb-8 leading-relaxed animate-fade-up-delay-2">Хотите поработать на свежем воздухе среди яблоневых садов? Приглашаем на сбор урожая в городе Лебедянь (садыТроекурово и Агроном)
...
Присоединяйтесь к нашей команде! Подробности по телефону: [номер телефона]</p>
