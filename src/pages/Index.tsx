      ...
      <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 pt-24 pb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-white/80 text-lg font-golos mb-8 leading-relaxed animate-fade-up-delay-2">Ищем сборщиков яблок в сады города Лебедянь (Троекурово и Агроном)
Свободный график,бесплатное питание,проезд.
